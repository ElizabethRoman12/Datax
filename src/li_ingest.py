...
#     """
#     Inserta publicaciones y métricas desde la Advertising API (Classic).
#     Usa organizationalEntityShareStatistics.
#     """
...
#             # Sanear fecha
#             created_time = None
#             if e.get("lastModified", {}).get("time"):
#                 try:
#                     created_time = datetime.fromtimestamp(
#                         int(e["lastModified"]["time"]) / 1000, tz=timezone.utc
...
#             publicacion = {
#                 "id": share_urn,
#                 "created_time": created_time,   # nunca None
#                 "message": None,  # Classic no da el texto del post
#                 "permalink_url": None,
#                 "status_type": None,
#                 "attachments": {},
...
#             # Métricas diarias (fallback: fecha de hoy)
#             dia = date.today()
#             metricas = {
...
#     except RuntimeError as e:
#         print(f"⚠ No se encontraron campañas en la cuenta {LI_AD_ACCOUNT_ID}: {e}")

# # ================================
# # Main
# # ================================
# def main():
#     print("→ LI: Ingesta de página (Classic)"); ingest_page_classic()
#     print("→ LI: Ingesta de seguidores (DMA)"); ingest_followers_dma()
#     print("→ LI: Ingesta de publicaciones (Classic)"); ingest_posts_classic()
#     print("→ LI: Ingesta de campañas (Ads)"); ingest_campaigns_ads()
#     print("→ LI: Ingesta complementaria (DMA)"); ingest_posts_dma()
...
def main():
    ...
    print("→ LI: Ingesta de publicaciones (Ads)")
    try:
        before_ok, before_skip = resumen["posts_ads"]["ok"], resumen["posts_ads"]["skip"]
        ingest_posts_classic()
        # Los contadores reales ya se imprimen en la función, aquí dejamos 0/0 por ahora
    except Exception as e:
        print(f"⚠ Error en ingest_posts_classic: {e}")
